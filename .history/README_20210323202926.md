...
2. I tried fixed the bert parameter or not pretrained by the pretraining_Bert_single.ipynb during training the whole model, the trained loss is better with not fixing the bert model parameters.