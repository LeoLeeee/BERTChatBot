...
2. I tried to fix the bert parameter or not pretrained by the pretraining_Bert_single.ipynb during training the whole model, the trained loss is better with not fixing the bert model parameters.